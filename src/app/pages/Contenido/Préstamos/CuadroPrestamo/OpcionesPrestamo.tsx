...
const OpcionesPrestamo = ({ onClose }: { onClose: () => void }) => {
    const { setSelectedOption } = useContext(PrestamosContext)

    return (
        <>
            <Link
                to={"/Prestamos/RegistrarPrestamo"}
            ...
            <Link
                to={"/Prestamos/RegistrarDevolucion/parcial"}
                className="opcionesClientes-Item hover:bg-zinc-200 cursor-pointer"
            >
                <div style={{ display: "flex", alignItems: "center" }}>
                    <svg
            ...
            <Link
                to={"/Prestamos/RegistrarDevolucion/total"}
                className="opcionesClientes-Item hover:bg-zinc-200 cursor-pointer"
            >
                <div style={{ display: "flex", alignItems: "center" }}>
                    <svg
