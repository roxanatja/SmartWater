    ...
    return(
        ...
        <div className="CuentasContales-container">
            ...
            <div style={{width: "324px"}}>
                <form className="search__container" style={{marginBottom: "0px"}} onSubmit={(e) => e.preventDefault()}>
            ...
            <div style={{display: "flex", flexDirection: "column", padding: "16px 0px", width: "100%", gap: "24px"}}>
