...
const PagoProveedores: FC = () => {
    ...
    return(
        ...
        <div>
            ...
            <PageTitle titulo="Reportes/ Pago a proveedores" icon="../../../Reportes-icon.svg"/>
                    ...
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-start"}}>
                        <div style={{display: "flex", alignItems: "flex-start", gap: "48px"}}>
                            <div style={{display: "flex", alignItems: "center", gap: "15px"}}>
                                <div className="CuentasPorPagar-Fecha">
                                    <span style={{textAlign: "left", width: "100%"}}>De</span>
                                    <div className="CuentasPorPagar-FechaInput">
                            ...
                            <div className="CuentasPorPagar-Productos">
                                <span className="CuentasPorPagar-Check" style={{color: "#1A3D7D"}}>Gastos</span>
                                <div className="CuentasPorPagar-ProductosCheck">
                                    <div className="CuentasPorPagar-Check">
                                        <input type="checkbox"/>
                        ...
                        <div>
                            <button className="CuentasPorPagar-btn">
