...
const PrestamosVsVentas:FC = () => {
    ...
    return(
        ...
        <div>
            ...
            <PageTitle titulo="Préstamos vs Ventas" icon="../../../Reportes-icon.svg"/>
            ...
            <div style={{marginTop: "32px"}}>
                    ...
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                        <div style={{display: "flex", alignItems: "center", gap: "15px"}}>
                            <div className="PrestamosVsVentas-Fecha">
                                ...
                                <div className="PrestamosVsVentas-FechaInput">
                        ...
                        <div>
                            <button className="PrestamosVsVentas-btn">
                ...
                <div style={{display: "flex", flexDirection: "column", marginTop: "40px", gap: "18px", alignItems: "start"}}>
                    <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "16px"}}>
                        ...
                        <span style={{fontFamily: "'Poppins', sans-serif", fontSize: "16px", fontWeight: "400", fontStyle: "normal"}}>Ventas</span>
                    </div>
                    <div style={{display: "flex", alignItems: "center", justifyContent: "center", gap: "16px"}}>
                        <span style={{width: "135px", height: "23px", borderRadius: "5px", background: "#1A3D7D"}}></span>
                        <span style={{fontFamily: "'Poppins', sans-serif", fontSize: "16px", fontWeight: "400", fontStyle: "normal"}}>Préstamos</span>
                    </div>
                </div>
            </div>
        </div>
