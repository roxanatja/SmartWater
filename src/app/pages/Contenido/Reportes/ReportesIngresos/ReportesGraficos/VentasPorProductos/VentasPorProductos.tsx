...
const VentasPorProductos: FC = () => {
    ...
    const handleClick = () => {
        navigate('/Reportes/Ingresos/Graficos');
    };
    ...
    return(
        ...
        <div>
            ...
            <PageTitle titulo="Ventas por producto" icon="../../../Reportes-icon.svg"/>
                    ...
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-start"}}>
                        <div style={{display: "flex", alignItems: "flex-start", gap: "48px"}}>
                            <div style={{display: "flex", alignItems: "center", gap: "15px"}}>
                                <div className="VentasPorProductos-Fecha">
                                    <span style={{textAlign: "left", width: "100%"}}>De</span>
                                    <div className="VentasPorProductos-FechaInput">
                            ...
                            <div className="VentasPorProductos-Productos">
                                <span className="VentasPorProductos-Check" style={{color: "#1A3D7D"}}>Producto</span>
                                <div className="VentasPorProductos-ProductosCheck">
                                    <div className="VentasPorProductos-Check">
                                        <input type="checkbox"/>
                                        <label>Botellon 20 lts</label>
                                    </div>
                                    <div className="VentasPorProductos-Check">
                                        <input type="checkbox"/>
                                        <label>Botellon 1 lts</label>
                                    </div>
                                    <div className="VentasPorProductos-Check">
                                        <input type="checkbox"/>
                                        <label>Botellon 10 lts</label>
                                    </div>
                                    <div className="VentasPorProductos-Check">
                                        <input type="checkbox"/>
                                        <label>Sachet 400 ml</label>
                                    </div>
                                    <div className="VentasPorProductos-Check">
                                        <input type="checkbox"/>
                                        <label>Todos</label>
                        ...
                        <div>
                            <button className="VentasPorProductos-btn">
