...
const VentasPorDistribuidor: FC = () => {
    ...
    return(
        ...
        <div>
            ...
            <PageTitle titulo="Venta por distribuidor" icon="../../../Reportes-icon.svg"/>
                    ...
                    <div style={{display: "flex", justifyContent: "space-between", alignItems: "flex-start"}}>
                        <div style={{display: "flex", alignItems: "flex-start", gap: "48px"}}>
                            <div style={{display: "flex", alignItems: "center", gap: "15px"}}>
                                <div className="VentasPorDistribuidor-Fecha">
                                    <span style={{textAlign: "left", width: "100%"}}>De</span>
                                    <div className="VentasPorDistribuidor-FechaInput">
                            ...
                            <div className="VentasPorDistribuidor-Productos">
                                <span className="VentasPorDistribuidor-Check" style={{color: "#1A3D7D"}}>Producto</span>
                                <div className="VentasPorDistribuidor-ProductosCheck">
                                    <div className="VentasPorDistribuidor-Check">
                                        <input type="checkbox"/>
                        ...
                        <div>
                            <button className="VentasPorDistribuidor-btn">
