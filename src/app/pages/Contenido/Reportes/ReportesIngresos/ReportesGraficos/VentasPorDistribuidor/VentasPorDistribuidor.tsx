...
const VentasPorDistribuidor: FC = () => {
    ...
    const loadData = useCallback(async () => {
        const res = await SalesApiConector.get({ filters: { initialDate: filters.initialDate || "2020-01-01", finalDate: filters.finalDate || moment().format("YYYY-MM-DD") }, pagination: { page: 1, pageSize: 30000 } })
        setReports(res?.data || [])
    }, [filters])
    ...
    return (
        <>
            <div className="px-10 h-full overflow-y-auto">
                <PageTitle titulo="Venta por usuario" icon="/Reportes-icon.svg" hasBack onBack={() => { navigate('/Reportes/Ingresos/Graficos'); }} />
