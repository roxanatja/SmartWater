...
const OpcionesVentas = ({ onClose }: { onClose: () => void }) => {
  const { setSelectedOption } = useContext(VentasContext);

  return (
    <>
      <Link
        to={"/Ventas/Registrarventa"}
      ...
      <Link
        to={"/Ventas/RegistrarDevolucion/parcial"}
        className="opcionesClientes-Item hover:bg-zinc-200 cursor-pointer"
      >
        <div style={{ display: "flex", alignItems: "center" }}>
          <svg
          ...
          >
            <path
              d="M2 2.22021H14.7746C18.5985 2.22021 21.8457 5.3905 21.9946 9.27156C22.1524 13.3726 18.8152 16.887 14.7746 16.887H5.33225"
              stroke="#1A3D7D"
              stroke-width="4"
      ...
      <Link
        to={"/Ventas/RegistrarDevolucion/total"}
        className="opcionesClientes-Item hover:bg-zinc-200 cursor-pointer"
      >
        <div style={{ display: "flex", alignItems: "center" }}>
          <svg
