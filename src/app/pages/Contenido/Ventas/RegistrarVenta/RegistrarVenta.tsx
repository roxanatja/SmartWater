...
const RegistrarVenta: FC = () => {
  ...
  const getClient = async () => {
    ...
    try {
      await GetClientById(selectedClient).then((resp) => {
        setClient(resp);
      });
    } catch (e) {
      console.error(e);
  ...
  return (
    <>
      <form onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="RegistrarVenta-opciones">
                  ...
                  <div className="RegistrarVenta-grupo-checbox">
                    ...
                    <div className="RegistrarVenta-grupo-check">
                      ...
                      />
                      <label className="text-check"></label>
                    </div>
                  </div>
                </div>
                        ...
                        <td>
                          ...
                          >
                            <OptionScrooll
                              options={Precio}
                              onOptionChange={(selectedOption) =>
                                setSelectedPrecio(selectedOption)
                              }
                            />
                          </div>
                        </td>
                ...
                {productosAgregados.length > 0 ? (
                  <>
                    {productosAgregados.map((item, index) => (
                      <div
                        className="RegistrarVenta-productoAgregado"
                        style={{
                          border:
        ...
        <div
          style={{ width: "100%", textAlign: "end", marginTop: "10px" }}
