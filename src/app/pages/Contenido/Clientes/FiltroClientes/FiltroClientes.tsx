...
const FiltroClientes: FC = () => {
  ...
  const [withoutLoansSelected, setWithoutLoansSelected] =
    useState<boolean>(false);
  const [withCreditSelected, setWithCreditSelected] = useState<boolean>(false);
  const [withoutCreditSelected, setWithoutCreditSelected] =
    useState<boolean>(false);
  ...
  const [localDaysToRenew, setLocalDaysToRenew] = useState<number>(daysToRenew);
  const [localDaysSinceRenewed, setLocalDaysSinceRenewed] =
    useState<number>(daysSinceRenewed);
  const [initialCreationDate, setInitialCreationDate] = useState<string>("");
  const [finalCreationDate, setFinalCreationDate] = useState<string>("");
  ...
  const handleFromDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setInitialCreationDate(selectedDate);
    setFromDate(selectedDate);
    if (finalCreationDate && moment(selectedDate).isAfter(finalCreationDate)) {
      setFinalCreationDate(
        moment(selectedDate).add(30, "days").format("YYYY-MM-DD")
      );
    }
    console.log(`Fecha inicial seleccionada: ${selectedDate}`);
    console.log(`Fecha final ajustada: ${finalCreationDate}`);
  };

  const handleToDateChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    const selectedDate = event.target.value;
    setFinalCreationDate(selectedDate);
    setToDate(selectedDate);
    if (
      initialCreationDate &&
      moment(selectedDate).isBefore(initialCreationDate)
    ) {
      setInitialCreationDate(
        moment(selectedDate).subtract(30, "days").format("YYYY-MM-DD")
      );
    }
    console.log(`Fecha final seleccionada: ${selectedDate}`);
    console.log(`Fecha inicial ajustada: ${initialCreationDate}`);
  };

  const saveFilters = () => {
    console.log("Saving filters:", {
      withCreditSelected,
      withoutCreditSelected,
      initialCreationDate,
      finalCreationDate,
      localDaysToRenew,
      localDaysSinceRenewed,
    });
    ...
    setDaysToRenew(localDaysToRenew);
    setDaysSinceRenewed(localDaysSinceRenewed);
    setShowFiltro(false);
  };
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                  ...
                  >
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M16.4034 6.91L15.186 5.5L10.3599 11.09L5.53374 5.5L4.31641 6.91L9.14256 12.5L4.31641 18.09L5.53374 19.5L10.3599 13.91L15.186 19.5L16.4034 18.09L11.5772 12.5L16.4034 6.91Z"
                        fill="black"
                        fill-opacity="0.87"
                      />
                    </svg>
            ...
            <div className="modal-body">
                  ...
                  <>
                    <div className="FiltroClientes-RenovaciónOption">
                      <div className="FiltroClientes-Renovadoinicio">
                        ...
                        <Contador
                          onIncrementar={() =>
                            setLocalDaysToRenew(localDaysToRenew + 1)
                          }
                          onDecrementar={() =>
                            setLocalDaysToRenew(localDaysToRenew - 1)
                          }
                      ...
                      <div className="FiltroClientes-Renovadoinicio">
                        ...
                        <Contador
                          onIncrementar={() =>
                            setLocalDaysSinceRenewed(localDaysSinceRenewed + 1)
                          }
                          onDecrementar={() =>
                            setLocalDaysSinceRenewed(localDaysSinceRenewed - 1)
                          }
                      ...
                      <div className="FiltroClientes-Fechascontainer">
                        <div className="FiltroClientes-Fecha">
                          ...
                          <div className="FiltroClientes-FechaInput">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="22"
                              height="24"
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                setInitialCreationDate(e.target.value)
                              }
                            />
                          </div>
                        </div>
                        <div className="FiltroClientes-Fecha">
                          ...
                          <div className="FiltroClientes-FechaInput">
                            ...
                            <input
                              type="date"
                              value={finalCreationDate}
                              onChange={(e) =>
                                setFinalCreationDate(e.target.value)
                              }
                            />
                          </div>
                        </div>
              ...
              <div className="FiltroClientes-Renovación">
                ...
                {opcionesVisibles && (
                  <>
                    <div className="FiltroClientes-Cuentas">
                      <div className="FiltroClientes-CuentasOption">
                      ...
                      <div className="FiltroClientes-CuentasPorCobrar">
              ...
              <div className="FiltroClientes-Renovación">
                ...
                {opcionesVisibles && (
                  <>
                    <div className="FiltroClientes-Distribuidores">
                      <div className="FiltroClientes-Fechastitulo">
                        <span>Distribuidores</span>
                      </div>
                      <div className="FiltroClientes-DistribuidoresOpcion">
                        <input className="input-check" type="checkbox" />
                        <label className="text-check">Distribuidor 1</label>
                      </div>
                      <div className="FiltroClientes-DistribuidoresOpcion">
                        <input className="input-check" type="checkbox" />
                        <label className="text-check">Distribuidor 2</label>
                      </div>
                    </div>
                    <div className="FiltroClientes-RenovaciónTitulo">
                      <span>Zonas</span>
                    ...
                    <div className="FiltroClientes-zona">
                      {zonesList.map((zone, index) => (
                        <div
                          key={index}
                          className="FiltroClientes-CuentasOptionTitulo"
                        >
                          <input
                            className="input-check"
                            type="checkbox"
