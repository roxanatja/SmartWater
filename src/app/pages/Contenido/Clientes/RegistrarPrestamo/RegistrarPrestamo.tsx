...
const RegistrarPrestamo: FC = () => {
  ...
  const saveEditProduct = () => {
    //Saves the edited product by updating the list of added products.
  ...
  const saveLoansData = async () => {
    //Saves the loan data in the database
    const allProducts = productosAgregados;
    setLoadingSale(true);

    if (allProducts.length === 0) {
      // Check if there are products to sale
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="RegistrarPrestamo-scrooll">
          <div className="RegistrarPrestamo-NombreCliente">
            ...
            <div
              className="RegistrarPrestamo-Nombre"
          ...
          <div className="RegistrarPrestamo-AgregarProducto">
            <div className="RegistrarPrestamo-AgregarProductoTitulo">
              ...
              <button
                ...
                className={
                  opcionesVisibles
                    ? "RegistrarPrestamo-btnAgregarProducto AgregarProductoactive-btn"
                    : "RegistrarPrestamo-btnAgregarProducto"
                }
              >
            ...
            {opcionesVisibles && (
              <>
                  ...
                  <table style={{ width: "100%", borderSpacing: "0px" }}>
                    ...
                    <tbody>
                      ...
                      >
                        <td>
                          <div
                            className="RegistrarPrestamo-TablaBody"
                ...
                <button
                  className="RegistrarPrestamo-agregarproducto"
                ...
                {productosAgregados.length > 0 ? (
                  <>
                    {productosAgregados.map((item, index) => (
                      <div
                        className="RegistrarPrestamo-productoAgregado"
                        style={{
                          border:
                      ...
                      >
                        <div className="RegistrarPrestamo-productoAgregado1">
                          ...
                          <div className="RegistrarPrestamo-productoAgregadobtncontainer">
                            <button
                              className="RegistrarPrestamo-productoAgregadoBTN"
          ...
          <div className="RegistrarPrestamo-FechaComentario">
            ...
            <div style={{ width: "100%" }}>
              <ImagenInsertar
                texto="Porfavor, adjunta la imagen del contrato"
                imagenSelect={imageContrato}
                onImagenSeleccionada={setImageContrato}
                id="contrato"
              />
            </div>
          </div>
        ...
        <div style={{ width: "100%", textAlign: "end", marginTop: "10px" }}>
          <button
            className="RegistrarPrestamo-btnVender"
            onClick={saveLoansData}
          >
