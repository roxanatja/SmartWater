    ...
    return(
        ...
        <div>
            ...
            <div style={{display: "flex", alignItems: "center", justifyContent: "right", width: "100%", marginTop: "25px"}}>
                <button className="Productos-btn" onClick={() => setFiltro(!filtro)}>
                    <span>Filtrar</span>
            ...
            <div className="Productos-zonas">
                <ProductosItem/>
                <ProductosItem/>
                <ProductosItem/>
                <ProductosItem/>
            </div>
            <div style={{display: "flex", gap: "20px", justifyContent: "flex-end", width: "20%", marginTop: "24px"}}>
