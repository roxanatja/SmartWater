...
const ConfiguracionGeneral: FC = () => {
    ...
    const [isCheckedLight, setIsCheckedLight] = useState<boolean>(false);
    ...
    const changeMode = (mode: 'light' | 'dark' | 'auto' = 'light') => {
        setTheme(mode)
    }
