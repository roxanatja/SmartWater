...
interface Props {
    data: Comission<'specific'>[];
    distribuidores: User[];
    className?: string;
}


const TableEspecificos = ({ data, className, distribuidores }: Props) => {
    const { setSelectedInvetario, setSelectedOption, setShowModal } = useContext(ComisionesEspecificosContext)
    ...
    const columns: TableColumn<Comission<'specific'>>[] = useMemo<TableColumn<Comission<'specific'>>[]>(() => [
        {
            name: "Fecha inicial",
...
export default TableEspecificos