                ...
                <div className="RegistrarPedido-scrooll">
                    ...
                    <div className="RegistrarPedido-AgregarProducto">
                        <div className="RegistrarPedido-AgregarProductoTitulo">
                            ...
                            <button onClick={handleOpcionesClick} className={opcionesVisibles ? "RegistrarPedido-btnAgregarProducto AgregarProductoactive-btn" : "RegistrarPedido-btnAgregarProducto"}>
                                <span className="material-symbols-outlined">
                                    expand_more
                                </span>
                            </button>
                                ...
                                <div style={{ width: "100%", marginTop: "25px" }}>
                                    <table style={{ width: "100%", borderSpacing: "0px" }}>
                                        ...
                                        <tbody>
                                            <tr style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                                                <td>
                                                    <div className="RegistrarPedido-TablaBody" style={{ borderRadius: "0px 0px 0px 20px" }}>
                                                        <OptionScrooll
                                                            options={Cantidad}
                    ...
                    <div className="RegistrarPedido-FechaComentario">
                        <div className="RegistrarPedido-AgregarComentario">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24" viewBox="0 0 25 24" fill="none">
                                <path d="M12.8047 11.5C12.1416 11.5 11.5058 11.2366 11.0369 10.7678C10.5681 10.2989 10.3047 9.66304 10.3047 9C10.3047 8.33696 10.5681 7.70107 11.0369 7.23223C11.5058 6.76339 12.1416 6.5 12.8047 6.5C13.4677 6.5 14.1036 6.76339 14.5725 7.23223C15.0413 7.70107 15.3047 8.33696 15.3047 9C15.3047 9.3283 15.24 9.65339 15.1144 9.95671C14.9887 10.26 14.8046 10.5356 14.5725 10.7678C14.3403 10.9999 14.0647 11.1841 13.7614 11.3097C13.4581 11.4353 13.133 11.5 12.8047 11.5ZM12.8047 2C10.9482 2 9.16769 2.7375 7.85494 4.05025C6.54219 5.36301 5.80469 7.14348 5.80469 9C5.80469 14.25 12.8047 22 12.8047 22C12.8047 22 19.8047 14.25 19.8047 9C19.8047 7.14348 19.0672 5.36301 17.7544 4.05025C16.4417 2.7375 14.6612 2 12.8047 2Z" fill="#1A3D7D" />
                            </svg>
                            <span>Agregar ubicación</span>
                        </div>
                        <div className="RegistrarPedido-AgregarComentario">
                            <div className="RegistrarPedido-Zona">
                                <img src="../punto-de-mira-de-ubicacion.svg" alt="" />
                                <select name="" id="">
                        ...
                        <div className="RegistrarPedido-AgregarComentario">
                            ...
                            <span>{fecha === null ? "Fecha de entrega" : moment(fecha).format('DD/MM/YYYY')}</span>
                        </div>
                        <div className="RegistrarPedido-AgregarComentario">
